<?php
 ...
 $query = "SELECT * FROM getsketch WHERE id='$id'";
					...
					<div class='container' style="padding:15px 56px 38px 310px;;">
						<div class='card'>
						   ...
						   <div>
							  ...
							  <input style="margin-bottom: 1%;" class="form-control form-control-lg" id="formFileLg" type="file" name="uploadsketch">
							</div>
						   <button class="btn button" style="font-size: 19px; padding: 10px 25px; margin: 1px;" role="button" name="uploadsketch">Upload Sketch</button>       
...
if(isset($_POST['uploadsketch']))
{
    ...
    $filename = $_FILES["uploadsketch"]["name"];
    $tempname = $_FILES["uploadsketch"]["tmp_name"];
...
{    
    ...
    $query = "INSERT INTO uploadSketch (firstname,lastname,yearofstudy,department,uploadedsketch) VALUES
    ...
    if($data)
    {
		...
		?>
		<meta http-equiv = "refresh" content = "0; url = viewsketchdata.php"/>
	   <?php
   }
  else
  {
