				...
				if($total != 0)
				{
    				...
    				while( $result = mysqli_fetch_assoc($data))
    				{
     					echo "
							 ...
							 <td><img src= 'uploadengpoemimg/".$result['image']."' height='80px' width='100px' >
                             <td>".$result['englishpoem']."</td> 
                             </td>

                             <td>
							    <a href='viewenglish.php?uid=$result[id]'>
								 <button class='button' name='view'>View</button>
								</a>
								 <a href='editengpoem.php?eepid=$result[id]'>
								 <button class='button' name='edit'>Edit</button>
								</a>
								 <a href='deleteengpoem.php?depid=$result[id]'>
