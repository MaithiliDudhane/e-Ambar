				...
				if($total != 0)
				{
    				...
    				while( $result = mysqli_fetch_assoc($data))
    				{
     					echo "
							 ...
							 <td><img src= 'Engpoemimage/".$result['image']."' height='80px' width='100px' >
							     <a download='Engpoemimage/".$result['image']."' href= 'Engpoemimage/".$result['image']."'>".$result['image']."</a>
							 </td>
							 <td><a href= 'EngPoem/".$result['poem']."'>".$result['poem']."</a></td>
							 <td><a href='uploadenglishpoem.php?uid=$result[id]'><button class='button'
							  name='upload'>Upload</button></a>
							  <a href='deleteenglishpoemdata.php?dvepid=$result[id]'><button class='button'
