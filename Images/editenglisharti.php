...
// error_reporting(0);
 ...
 $query = "SELECT * FROM uploadenglisharticle WHERE id='$id'";
...
<head>
  ...
  <a href="viewengartidata.php">
           ...
           <div>
              ...
              <?php echo "<img src= 'uploadengartiimg/".$result['image']."' height='100px' width='150px' >";?>
              <div>
            ...
            <div>
              <label for="article">RestFull Article</label>
               <textarea id="article" name="fularticle">
                  <?php echo $result['englisharticle'];?>
               </textarea>
            </div>
           <button class="btn button" style="  font-size: 19px; padding: 10px 25px; margin: 1px;margin-top: 2%;"
            role="button" name="editenglisharticle">Edit English Article</button>  
...
if(isset($_POST['editenglisharticle']))
{
   ...
   else
   {
    ...
    if($artiname !="" && $fname !="" && $lname !=""  && $year !="" && $dept !="" && $article !="" 
    && $secarticle !="" && $thirdarticle !="" && $fullarticle !="")
{
    $query = "UPDATE uploadenglisharticle SET articlename='$artiname',firstname='$fname',lastname='$lname',yearofstudy='$year',
    department='$dept',image='$filename',summery='$article',summerysec='$secarticle',
    summerythird='$thirdarticle',englisharticle='$fullarticle' WHERE id='$id'";
