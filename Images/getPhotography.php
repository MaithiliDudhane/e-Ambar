...
<head>
    ...
    <link rel="stylesheet" href="getPhotopraphy.css">

</head>
<title>Get Photography</title>
...
<nav aria-label="breadcrumb" style="margin-left:40px;">
    ...
    <div class="container" style=" box-shadow: 1px 1px 9px #842053;">
        <form method="POST" enctype="multipart/form-data">
            ...
            <div>
                <label for="formFileLg" class="form-label">Upload your photograph</label>
                <input style="margin-bottom: 2%;" class="form-control form-control-lg" id="formFileLg" type="file"
                    name="photography">
            </div>
...
if(isset($_POST['Share']))
{
    ...
    $filename = $_FILES["photography"]["name"];
    $tempname = $_FILES["photography"]["tmp_name"];
   ...
   {
    $folder = "photography/".$filename;
    move_uploaded_file($tempname,$folder);
    
    if($fname !="" && $lname !=""  && $year !="" && $dept !="" && $filename !="")
{
    $query = "INSERT INTO getPhography (firstname,lastname,yearofstudy,department,photography) VALUES('$fname','$lname','$year','$dept','$filename')";
