				...
				if($total != 0)
				{
    				...
    				while( $result = mysqli_fetch_assoc($data))
    				{
     					echo "
							 ...
							 <td><img src= 'Hindiimage/".$result['image']."' height='80px' width='100px' >
							     <a download='Hindiimage/".$result['image']."' href= 'Hindiimage/".$result['image']."'>"
								 .$result['image']."</a>
							 </td>
							 <td><a href= 'HindiArticle/".$result['hindiarticle']."'>".$result['hindiarticle']."</a></td>
							 <td><a href='uploadhindiarti.php?uid=$result[id]'><button class='button'
							  name='upload'>Upload</button></a>
							  <a href='deletehindiartidata.php?dvhaid=$result[id]'><button class='button'
