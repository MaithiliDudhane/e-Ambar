	...
	<div id="stuinfo" class='container' style="margin-top:40px;">
		<div class='card'>
			<div class='card-header'>
				<h1>Uploaded English Article</h1>
			</div>
			<div class='card-body'>
				<!DOCTYPE html>
				<html>
				...
				if($total != 0)
				{
    				...
    				while( $result = mysqli_fetch_assoc($data))
    				{
     					echo "
							 ...
							 <td><img src= 'uploadengartiimg/".$result['image']."' height='80px' width='100px' >
                             <td>".$result['englisharticle']."</td> 
                             </td>
                             <td>
							    <a href='viewenglish.php?uid=$result[id]'>
								 <button class='button' name='view'>View</button>
								</a>
								 <a href='editenglisharti.php?eeaid=$result[id]'>
								 <button class='button' name='edit'>Edit</button>
								</a>
								 <a href='deleteengarti.php?deaid=$result[id]'>
