...
<div style="text-align: center;margin-bottom: 2%;">
    ...
    <form action="#" method="POST" enctype="multipart/form-data">
            ...
            <label for="name">कवितेचे नाव (Poem Name)</label>
            <input type="text" id="fname" name="poemname" placeholder="कवितेचे नाव..">
            ...
            <div>
                ...
                <input style="margin-bottom: 1%;" class="form-control form-control-lg" id="formFileLg" type="file" name="Marathipoem">
              </div>
...
if(isset($_POST['Share']))
{
   ...
   else
   {
    ...
    $file = $_FILES["Marathipoem"]["name"];
    $tmpname = $_FILES["Marathipoem"]["tmp_name"];
   ...
   {
    $folder = "Marathipoemimg/".$filename;
    move_uploaded_file($tempname,$folder);
    $folder = "MarathiPoem/".$file;
    move_uploaded_file($tmpname,$folder);

    if($poemname !="" && $fname !="" && $lname !=""  && $year !="" && $dept !="" && $filename !="" && $file !="")
{
    $query = "INSERT INTO getmarathipoem (poemname,firstname,lastname,yearofstudy,department,image,Marathipoem) VALUES('$poemname','$fname','$lname','$year','$dept','$filename','$file')";
