				...
				if($total != 0)
				{
    				...
    				while( $result = mysqli_fetch_assoc($data))
    				{
     					echo "
							 ...
							 <td><img src= 'sketch/".$result['sketch']."' height='80px' width='100px' >
							 <a download='sketch/".$result['sketch']."'' href= 'sketch/".$result['sketch']."'>".$result['sketch']."</a></td>

							 <td><a href='uploadsketch.php?uid=$result[id]'><button class='button' 
							 name='upload'>Upload</button></a>
							 <a href='deletesketchdata.php?dvsid=$result[id]'><button class='button'
