<?php
 ...
 $query = "SELECT * FROM gethindipoem WHERE id='$id'";
...
<a href="viewhindipoemdata.php">
           ...
           <button class="btn button" style="  font-size: 19px; padding: 10px 25px; margin: 1px;margin-top: 2%;"
            role="button" name="uploadHpoem">Upload Hindi Poem</button> 
...
{
    $query = "INSERT INTO uploadhindipoem (poemname,firstname,lastname,yearofstudy,department,image,hindipoem)
    VALUES('$poemname','$fname','$lname','$year','$dept','$filename','$Hpoem')";
    ...
    if($data)
    {
        ...
        ?>
        <meta http-equiv = "refresh" content = "0; url = viewhindipoemdata.php"/>
       <?php
   }
  else
  {
