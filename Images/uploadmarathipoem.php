<?php
 ...
 $query = "SELECT * FROM getmarathipoem WHERE id='$id'";
...
<body style="background-color:#fcf8f8;">	
           ...
           <button class="btn button" style="font-size: 19px; padding: 10px 25px; margin: 1px;margin-top: 2%;"
            role="button" name="uploadMpoem">Upload Marathi Poem</button>       
        </form>
      </div>
    </div>
</body>			
...
{
    $query = "INSERT INTO uploadmarathipoem (poemname,firstname,lastname,yearofstudy,department,image,marathipoem)
    VALUES('$poemname','$fname','$lname','$year','$dept','$filename','$Mpoem')";
    ...
    if($data)
    {
        ...
        ?>
        <meta http-equiv = "refresh" content = "0; url = viewmarathipoemdata.php"/>
       <?php
   }
  else
  {
