<?php
 ...
 $query = "SELECT * FROM getmarathiarticle WHERE id='$id'";
...
<a href="viewmarathiartidata.php">
           ...
           <button class="btn button" style="  font-size: 19px; padding: 10px 25px; margin: 1px;margin-top: 2%;" 
           role="button" name="uploadmarathiarti">Upload Marathi Article</button> 
...
if(isset($_POST['uploadmarathiarti']))
{
...
{
    $query = "INSERT INTO uploadmarathiarticle (articlename,firstname,lastname,yearofstudy,department,image,summery,
    summerysec,summerythird,marathiarticle) VALUES ('$artiname','$fname','$lname','$year','$dept','$filename',
    ...
    if($data)
    {
        ...
        ?>
        <meta http-equiv = "refresh" content = "0; url = viewmarathiartidata.php"/>
       <?php
   }
  else
  {
