	...
	<div id="stuinfo" class='container' style="margin-top:40px;">
		   <div class='card'>
			...
			<div class='card-body'>
				...
				$query = "SELECT * FROM uploadmarathipoem";
				...
				if($total != 0)
				{
    				...
    				while( $result = mysqli_fetch_assoc($data))
    				{
     					echo "
							 ...
							 <td><img src= 'uploadmarathipoemimg/".$result['image']."' height='80px' width='100px' >
                             <td>".$result['marathipoem']."</td> 
                             </td>
                             ...
                             <td> 
							    <a href='viewmarathi.php?uid=$result[id]'>
								 ...
								 <a href='editmarathipoem.php?empid=$result[id]'>
								 <button class='button' name='edit'>Edit</button>
								</a>
								 <a href='deletemarathipoem.php?dmpid=$result[id]'>
