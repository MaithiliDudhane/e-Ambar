	...
	<div id="stuinfo" class='container' style="margin-top:40px;">	
	    <div class='card'>
			...
			<div class='card-body'>
				...
				$query = "SELECT * FROM uploadhindiarticle";
				...
				if($total != 0)
				{
    				...
    				while( $result = mysqli_fetch_assoc($data))
    				{
     					echo "
							 ...
							 <td><img src= 'uploadhindiartiimg/".$result['image']."' height='80px' width='100px' >
                             <td>".$result['hindiarticle']."</td> 
                             </td>
                             ...
                             <td>
								...
								<a href='edithindiarti.php?ehaid=$result[id]'>
								 <button class='button' name='edit'>Edit</button>
								</a>
								<a href='deletehindiarti.php?dhaid=$result[id]'>
