	...
	<div id="stuinfo" class='container' style="margin-top:40px;">
		   ...
		   <div class='card'>
			...
			<div class='card-body'>
				...
				}				$query = "SELECT * FROM uploadphography";
				...
				if($total != 0)
				{
    				...
    				while( $result = mysqli_fetch_assoc($data))
    				{
     					echo "
							 ...
							 <td><img src= 'uploadphography/".$result['uploadedphography']."' height='80px' width='100px' >
							 <td>
							    <a href='sectionphotography.php?uid=$result[id]'>
								 <button class='button' name='view'>View</button>
								</a>
								 <a href='editphotography.php?epid=$result[id]'>
								 <button class='button' name='edit'>Edit</button>
								</a>
								 <a href='uploadphotography.php?dpid=$result[id]'>
