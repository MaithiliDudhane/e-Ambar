					...
					?>
						...
						while( $result = mysqli_fetch_assoc($data))
						{
							echo "
								...
								<td><img src= 'Marathipoemimg/".$result['image']."' height='80px' width='100px' >
									<a download='Marathipoemimg/".$result['image']."' 
									href= 'Marathipoemimg/".$result['image']."'>".$result['image']."</a>
								</td>
								<td><a href= 'MarathiPoem/".$result['Marathipoem']."'>".$result['Marathipoem']."</a></td>
								<td><a href='uploadmarathipoem.php?uid=$result[id]'><button class='button' 
								name='upload'>Upload</button></a>
								<a href='deletemarathipoemdata.php?dvmpid=$result[id]'><button class='button'
