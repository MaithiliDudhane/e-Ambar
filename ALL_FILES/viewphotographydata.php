				...
				if($total != 0)
				{
    				...
    				while( $result = mysqli_fetch_assoc($data))
    				{
     					echo "
							 ...
							 <td><img src= 'photography/".$result['photography']."' height='80px' width='100px' >
							 <a download='photography/".$result['photography']."' href= 'photography/".$result['photography']."''>".$result['photography']."</a></td>
							 <td>
								 <a href='uploadphotography.php?uid=$result[id]'>
								 <button class='button' name='upload'>Upload</button>
								</a>
								<a href='deletephotographydata.php?dvpid=$result[id]'><button class='button'
