...
<div style="text-align: center;margin-bottom: 2%;">
    ...
    <form action="#" method="POST" enctype="multipart/form-data">
            ...
            <label for="name">अनुच्छेद नाम (Article name)</label>
            <input type="text" id="fname" name="articlename" placeholder="अनुच्छेद नाम..">
            ...
            <div>
            <label for="formFileLg" class="form-label">लेख (Article)</label>
                <input style="margin-bottom: 1%;" class="form-control form-control-lg" id="formFileLg" type="file" name="hindiarticle">
              </div>
...
if(isset($_POST['Share']))
{
   ...
   else
   {
    ...
    $file = $_FILES["hindiarticle"]["name"];
    $tmpname = $_FILES["hindiarticle"]["tmp_name"];
   ...
   {
    $folder = "Hindiimage/".$filename;
    move_uploaded_file($tempname,$folder);
    $folder = "HindiArticle/".$file;
    move_uploaded_file($tmpname,$folder);
    

    if($artiname !="" && $fname !="" && $lname !="" && $year !="" && $dept !="" && $filename !="" && $file !="")
{
    $query = "INSERT INTO gethindiarticle (articlename,firstname,lastname,yearofstudy,department,image,hindiarticle) VALUES('$artiname','$fname','$lname','$year','$dept','$filename','$file')";
