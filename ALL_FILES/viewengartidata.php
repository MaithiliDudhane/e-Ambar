				...
				if($total != 0)
				{
    				...
    				while( $result = mysqli_fetch_assoc($data))
    				{
     					echo "
							 ...
							 <td><img src= 'Engimage/".$result['image']."' height='80px' width='100px' >
								 <a download='Engimage/".$result['image']."' href= 'Engimage/".$result['image']."'>
								     ".$result['image']."
								 </a>
							 </td>
							 <td>
							     <a href= 'EngArticle/".$result['article']."'>
								     ".$result['article']."
								 </a>
							 </td>
							 <td>
							  <a href='uploadenglisharti.php?uid=$result[id]'>
							     <button class='button' name='upload'>Upload</button>
							  </a>
							  <a href='deletehindipoemdata.php?dveaid=$result[id]'><button class='button'
