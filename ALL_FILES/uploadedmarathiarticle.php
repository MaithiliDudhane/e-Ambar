	...
	<div id="stuinfo" class='container' style="margin-top:40px;">
		   <div class='card'>
			<div class='card-header'>
				<h1>Uploaded Marathi Article</h1>
			</div>
			<div class='card-body'>
				<!DOCTYPE html>
				<html>
				...
				}				$query = "SELECT * FROM uploadmarathiarticle";
				...
				if($total != 0)
				{
    				...
    				while( $result = mysqli_fetch_assoc($data))
    				{
     					echo "
							 ...
							 <td><img src= 'uploadmarathiartiimg/".$result['image']."' height='80px' width='100px' >
                             <td>".$result['marathiarticle']."</td> 
                             </td>

                             <td>  
							    <a href='viewmarathi.php?uid=$result[id]'>
								 <button class='button' name='view'>View</button>
								</a>
								 <a href='editmarathiarti.php?emaid=$result[id]'>
								 <button class='button' name='edit'>Edit</button>
								</a>
								 <a href='deletemarathiarti.php?dmaid=$result[id]'>
